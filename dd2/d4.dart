...
void main() {
  ...
  if (circuloaiorPerimetro.perimetro > retanguloMaiorPerimetro.perimetro) {
    print(
...
class ComparadorFormasGeometricas {
  // Métodos que comparam duas formas e retornam a que possui maior
  // métrica (área ou perímetro) conforme solicitado.
